...
<div class="login-wrapper ">
    ...
    <div class="bg-pic" style="background:#5287b1 url(/assets/img/login_bg.jpg) repeat-x scroll 0 0">
        <!-- START Background Pic-->
<!--        <img src="/assets/img/admin_login_screen.jpg" alt="" class="lazy" style="opacity: 1">-->
        <img src="/assets/img/login_notebook.png" alt="" style="opacity: 1 !important; height: auto;opacity: 0.6;bottom: 30px;position: absolute;left: 1%;">
        <!-- END Background Pic-->
        <!-- START Background Caption-->
        <div class="bg-caption text-white p-l-20 m-b-20 " style="top:20%; left:7%; position: absolute; font-size:25px; width: 50%">
            <h2 class="semi-bold text-white" style="font-size: 40px; font-weight: bold !important; text-align: center">Reward &amp; Pension</h2>
            <h3 class="semi-bold text-white" style="text-align: center;">Administration portal</h3>
...
<!--            <img src="assets/img/logo.png" alt="logo" data-src="assets/img/logo.png" data-src-retina="assets/img/logo.png" height="45" >-->
            <img src="/clients/default/images/logo.png" alt="logo" data-src="/assets/img/logo.png" data-src-retina="/clients/default/images/logo.png" style="max-width: 100px">
