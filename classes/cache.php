<?php
  ...
  * http://www.megazin.cz/
  *
  * 2006-2007, (c) Ondrej Dadok
  * http://www.beorange.cz/
  *
...
class Cache
{
    ...
    function get($id, $group = 'default', $doNotTestCacheValidity = false)
    {
        ...
        if ($this->_caching) {
            ...
            if ($doNotTestCacheValidity) {
                ...
                //echo filemtime($this->_file) .' > '. $this->_refreshTime;
    ...
    */
    ...
    {
       $path = defined('ROOTMASTER')?ROOTMASTER:ROOT;
        include_once($path.'PEAR.php');
